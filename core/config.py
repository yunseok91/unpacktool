...
# Webdriver 관련 설정
WEBDRIVER_PATH = {
    'edge': os.path.join(ROOT_DIR, 'webdriver_manager', 'edgedriver_137', 'msedgedriver.exe'),
    'chrome': os.path.join(ROOT_DIR, 'webdriver_manager', 'chromedriver_137', 'chromedriver.exe')
}
